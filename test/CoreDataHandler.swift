...
class CoreDataHandler: NSObject {
    ...
    func save(array:Array<String>, picture: NSData){
        var entry:NSManagedObject = NSEntityDescription.insertNewObjectForEntityForName("Person", inManagedObjectContext: managedObjectContext) as NSManagedObject
        entry.setValue(array[0], forKey: "name")
        entry.setValue(array[1], forKey: "surname")
        entry.setValue(array[2], forKey: "sirket")
    ...
    func getData(name:String) -> NSArray {
        
        var fetchRequest:NSFetchRequest=NSFetchRequest(entityName: "Person")
